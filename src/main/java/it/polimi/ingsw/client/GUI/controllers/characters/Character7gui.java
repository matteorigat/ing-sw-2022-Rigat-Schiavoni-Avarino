...
import it.polimi.ingsw.model.gameboard.characters.Character7;
...
public class Character7gui implements Character{

    @FXML public ImageView student0, student1, student2, student3, student4, student5;
    @FXML public Label selected0, selected1, selected2, selected3, selected4, selected5;
    ...
    int[][] select = new int[2][3];
    int[][] entranceselect = new int[2][3];

    int counter = 0, counter2 = 0;
    private ClientAppGUI gui;
    private ArrayList<Student> students, students2;
    private Model model;
    ...
    protected void onButtonClick() {
        ...
        if(select[0][0] != -1 && entranceselect[0][0] != -1 && select[0][1] == -1 && entranceselect[0][1] == -1 && select[0][2] == -1 && entranceselect[0][2] == -1){
            Platform.runLater(()-> gui.getClientGUI().asyncWriteToSocket("100,7," + select[0][0] + "," + entranceselect[0][0]));
            dialog.close();
        } else if(select[0][0] != -1 && entranceselect[0][0] != -1 && select[0][1] != -1 && entranceselect[0][1] != -1 && select[0][2] == -1 && entranceselect[0][2] == -1){
            Platform.runLater(()-> gui.getClientGUI().asyncWriteToSocket("100,7," + select[0][0] + "," + entranceselect[0][0] + "," + select[0][1] + "," + entranceselect[0][1]));
            dialog.close();
        } else if(select[0][0] != -1 && entranceselect[0][0] != -1 && select[0][1] != -1 && entranceselect[0][1] != -1 && select[0][2] != -1 && entranceselect[0][2] != -1){
            Platform.runLater(()-> gui.getClientGUI().asyncWriteToSocket("100,7," + select[0][0] + "," + entranceselect[0][0] + "," + select[0][1] + "," + entranceselect[0][1] + "," + select[0][2] + "," + entranceselect[0][2]));
            dialog.close();
        }
    }
    ...
    public void setModel(Model model, int cardPosition){
        ...
        Character7 card = (Character7) model.getGameBoard().getThreeCharacterCards().get(cardPosition);
        ...
        for(int i=0; i<students.size(); i++){
            if(i==0){
                ...
                student4.setImage(getStudentImage(students.get(4).getColour()));
            } else if(i==5){
                student5.setImage(getStudentImage(students.get(5).getColour()));
            }
        }
    ...
    protected void chooseStudent0() {
        ...
        if(counter == 0){
            select[0][0] = students.get(0).getColour().ordinal();
            removeSelected(select[1][0]);
            selected0.setText("°");
            select[1][0] = 0;
            counter++;
        }
        else if(counter == 1){
            select[0][1] = students.get(0).getColour().ordinal();
            ...
            select[0][2] = students.get(0).getColour().ordinal();
            removeSelected(select[1][2]);
            selected0.setText("°");
            select[1][2] = 0;
            counter = 0;
        }
    ...
    protected void chooseStudent1() {
        ...
        if(counter == 0){
            select[0][0] = students.get(1).getColour().ordinal();
            removeSelected(select[1][0]);
            selected1.setText("°");
            select[1][0] = 1;
            counter++;
            ...
            select[0][1] = students.get(1).getColour().ordinal();
            removeSelected(select[1][1]);
            selected1.setText("°");
            select[1][1] = 1;
            counter++;
            ...
            select[0][2] = students.get(1).getColour().ordinal();
            removeSelected(select[1][2]);
            selected1.setText("°");
            select[1][2] = 1;
            counter = 0;
    ...
    protected void chooseStudent2() {
        ...
        if(counter == 0){
            select[0][0] = students.get(2).getColour().ordinal();
            removeSelected(select[1][0]);
            selected2.setText("°");
            select[1][0] = 2;
            counter++;
            ...
            select[0][1] = students.get(2).getColour().ordinal();
            removeSelected(select[1][1]);
            selected2.setText("°");
            select[1][1] = 2;
            counter++;
            ...
            select[0][2] = students.get(2).getColour().ordinal();
            removeSelected(select[1][2]);
            selected2.setText("°");
            select[1][2] = 2;
            counter = 0;
    ...
    protected void chooseStudent3() {
        ...
        if(counter == 0){
            select[0][0] = students.get(3).getColour().ordinal();
            removeSelected(select[1][0]);
            selected3.setText("°");
            select[1][0] = 3;
            counter++;
            ...
            select[0][2] = students.get(3).getColour().ordinal();
            removeSelected(select[1][2]);
            selected3.setText("°");
            select[1][2] = 3;
            counter = 0;
    ...
    protected void chooseStudent4() {
        ...
        if(counter == 0){
            select[0][0] = students.get(4).getColour().ordinal();
            removeSelected(select[1][0]);
            selected4.setText("°");
            select[1][0] = 4;
            counter++;
            ...
            select[0][1] = students.get(4).getColour().ordinal();
            removeSelected(select[1][1]);
            selected4.setText("°");
            select[1][1] = 4;
            counter++;
            ...
            select[0][2] = students.get(4).getColour().ordinal();
            removeSelected(select[1][2]);
            selected4.setText("°");
            select[1][2] = 4;
            counter = 0;
    ...
    protected void chooseStudent5() {
        ...
        if(counter == 0){
            select[0][0] = students.get(5).getColour().ordinal();
            removeSelected(select[1][0]);
            selected5.setText("°");
            select[1][0] = 5;
            counter++;
            ...
            select[0][1] = students.get(5).getColour().ordinal();
            removeSelected(select[1][1]);
            selected5.setText("°");
            select[1][1] = 5;
            counter++;
            ...
            select[0][2] = students.get(5).getColour().ordinal();
            removeSelected(select[1][2]);
            selected5.setText("°");
            select[1][2] = 5;
            counter = 0;
    ...
    protected void chooseEntrance0() {
        ...
        if(counter2 == 0){
            ...
            entranceselect[0][2] = students2.get(0).getColour().ordinal();
            removeEntranceSelected(entranceselect[1][2]);
            entranceselected0.setText("°");
            entranceselect[1][2] = 0;
            counter2 = 0;
        }
    }
    ...
    protected void chooseEntrance1() {
        ...
        if(counter2 == 0){
            ...
            entranceselect[0][2] = students2.get(1).getColour().ordinal();
            removeEntranceSelected(entranceselect[1][2]);
            entranceselected1.setText("°");
            entranceselect[1][2] = 1;
            counter2 = 0;
        }
    }
    ...
    protected void chooseEntrance2() {
        ...
        if(counter2 == 0){
            ...
            entranceselect[0][2] = students2.get(2).getColour().ordinal();
            removeEntranceSelected(entranceselect[1][2]);
            entranceselected2.setText("°");
            entranceselect[1][2] = 2;
            counter2 = 0;
        }
    }
    ...
    protected void chooseEntrance3() {
        ...
        if(counter2 == 0){
            ...
            entranceselect[0][2] = students2.get(3).getColour().ordinal();
            removeEntranceSelected(entranceselect[1][2]);
            entranceselected3.setText("°");
            entranceselect[1][2] = 3;
            counter2 = 0;
        }
    }
    ...
    protected void chooseEntrance4() {
        ...
        if(counter2 == 0){
            ...
            entranceselect[0][2] = students2.get(4).getColour().ordinal();
            removeEntranceSelected(entranceselect[1][2]);
            entranceselected4.setText("°");
            entranceselect[1][2] = 4;
            counter2 = 0;
        }
    }
    ...
    protected void chooseEntrance5() {
        ...
        if(counter2 == 0){
            ...
            entranceselect[0][2] = students2.get(5).getColour().ordinal();
            removeEntranceSelected(entranceselect[1][2]);
            entranceselected5.setText("°");
            entranceselect[1][2] = 5;
            counter2 = 0;
        }
    }
    ...
    protected void chooseEntrance6() {
        ...
        if(counter2 == 0){
            ...
            entranceselect[0][2] = students2.get(6).getColour().ordinal();
            removeEntranceSelected(entranceselect[1][2]);
            entranceselected6.setText("°");
            entranceselect[1][2] = 6;
            counter2 = 0;
        }
    }
    ...
    protected void chooseEntrance7() {
        ...
        if(counter2 == 0){
            ...
            entranceselect[0][2] = students2.get(7).getColour().ordinal();
            removeEntranceSelected(entranceselect[1][2]);
            entranceselected7.setText("°");
            entranceselect[1][2] = 7;
            counter2 = 0;
        }
    }
    ...
    protected void chooseEntrance8() {
        ...
        if(counter2 == 0){
            ...
            entranceselect[0][2] = students2.get(8).getColour().ordinal();
            removeEntranceSelected(entranceselect[1][2]);
            entranceselected8.setText("°");
            entranceselect[1][2] = 8;
            counter2 = 0;
        }
    }
